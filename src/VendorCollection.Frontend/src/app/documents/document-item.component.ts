...
const template = require("./document-item.component.html");
const styles = require("./document-item.component.scss");

export class DocumentItemComponent extends HTMLElement {
    constructor(
    ...
    private async _onDeleteClick(e:Event) {
        await this._documentService.remove({ id: this.entity.id });		
		this.parentNode.removeChild(this);
    }

    private _onEditClick() {
        this._router.navigate(["document", "edit", this.entity.id]);
    }

    private _onViewClick() {
        this._router.navigate(["document","view",this.entity.id]);
    }
...
customElements.define(`ce-document-item`,DocumentItemComponent);
