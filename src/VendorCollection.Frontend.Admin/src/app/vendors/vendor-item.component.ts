...
const template = require("./vendor-item.component.html");
const styles = require("./vendor-item.component.scss");

export class VendorItemComponent extends HTMLElement {
    constructor(
    ...
    private async _onDeleteClick(e:Event) {
        await this._vendorService.remove({ id: this.entity.id });		
		this.parentNode.removeChild(this);
    }

    private _onEditClick() {
        this._router.navigate(["vendor", "edit", this.entity.id]);
    }

    private _onViewClick() {
        this._router.navigate(["vendor","view",this.entity.id]);
    }
...
customElements.define(`ce-vendor-item`,VendorItemComponent);
